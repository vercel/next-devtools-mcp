...
describe('MCP Server Registration', () => {
  ...
  it('should register all resources correctly', async () => {
    ...
    try {
      ...
      console.log('Registered resources:', resources.map((r: any) => r.uri || r.name))
      ...
      const hasKnowledgeResources = resourceURIs.some((uri: string) =>
        uri.includes('nextjs16') || uri.includes('knowledge')
      )
